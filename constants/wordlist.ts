export const WORDS = [
  ...
  {
    word: 'entera',
    song: 'No Me Conoce - Remix',
    spotifyUrl: 'https://open.spotify.com/track/4R8BJggjosTswLxtkw8V7P'
  },
  {
    word: 'tiempo',
    song: 'De Museo',
  ...
  },
  {
    ...
    spotifyUrl: 'https://open.spotify.com/track/2XIc1pqjXV3Cr2BQUGNBck'
  },
  {
    word: 'itachi',
    song: 'Yonaguni',
  ...
  },
  {
    word: 'mañana',
    song: 'Sensualidad',
    spotifyUrl: 'https://open.spotify.com/track/5hcisvFMidkMJlElTO9Qmw'
  },
  {
    word: 'prende',
    song: 'La Cartera',
    spotifyUrl: 'https://open.spotify.com/track/1g2Z2lOrwayOzDqOc8EfbR'
  },
  {
    word: 'bebida',
    song: 'Callaíta',
    spotifyUrl: 'https://open.spotify.com/track/2TH65lNHgvLxCKXM3apjxI'
  },
  {
    word: 'pensar',
    song: 'Ni Bien Ni Mal',
    spotifyUrl: 'https://open.spotify.com/track/278kSqsZIiYp8p3QjYAqa8'
  },
  {
    word: 'volver',
    song: 'Que Pretendes',
    spotifyUrl: 'https://open.spotify.com/track/25ZAibhr3bdlMCLmubZDVt'
  },
  {
    word: 'probar',
    song: 'Mia',
